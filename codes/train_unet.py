...
rgb = [30,50,90]
path_prefix = "./save_model/houston_unet3d_patch16_without_downsample_kernal5_fix"
...
def train():
    dataloader = HSIDataLoader(
        {"data":{"data_sign":"Houston", "padding":False, "batch_size":batch_size, "patch_size":patch_size, "select_spectral":select_spectral}})
